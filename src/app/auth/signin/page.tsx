      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/80 p-8 shadow-xl backdrop-blur-sm">
          ...
          <form
            onSubmit={(e) => {
              e.preventDefault();
              // Placeholder: magic link not functional yet
            }}
          >
            <label
              htmlFor="email"
            ...
            <button
              type="submit"
              className="mt-4 w-full rounded-lg bg-indigo-600 py-3 text-sm font-semibold text-white transition-colors hover:bg-indigo-500"
            >
              Invia Magic Link
            </button>
          </form>
